...
global direccionIp
global mascaraSubred
global servidoresDNS
global puertaEnlace
...
class DHCPOffer:
    ...
    def printOffer(self):
        ...
        global servidoresDNS
        global puertaEnlace
        direccionIp = self.offerIP
        mascaraSubred=self.subnetMask
        servidoresDNS=self.DNS[0]
        puertaEnlace= self.router
...
if __name__ == '__main__':
    ...
    # Creamos el String que vamos a utilizar para asignar Dir Ip, puerta de enlace y mascara de subred
    comandoOS = "netsh interface ip set address name=" + "Ethernet static " + direccionIp + " " + mascaraSubred + " " + puertaEnlace
    print (comandoOS)
    os.system(comandoOS)


    #Creamos el string que vamos a utilizar para asignar las direcciones DNS
    comandoDNSOS="netsh interface ip set dns name=Ethernet static "+servidoresDNS
    print (comandoDNSOS)
    os.system(comandoDNSOS)

    input('Fin de la ejecucion, pulse cualquier tecla para salir...')
    exit()
